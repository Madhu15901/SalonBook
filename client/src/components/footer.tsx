      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li><span className="text-white/70">Hair Styling</span></li>
              <li><span className="text-white/70">Facial Treatments</span></li>
              <li><span className="text-white/70">Nail Care</span></li>
              <li><span className="text-white/70">Makeup Services</span></li>
              <li><span className="text-white/70">Massage Therapy</span></li>
            </ul>
          </div>
